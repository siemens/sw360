...
#
# This script merge copy todos from project to obligationList model and and removes the todos field from roject
# -------------------------------------------------------------------------------------------------------------
...
all_project_with_todos = {"selector": {"type": {"$eq": "project"}, "todos": {"$exists": True}}}
        ...
        if len(todos) > 0:
            if linkedOblId is None:
                ...
                for todo in todos:
                    ...
                    obligationStatusInfo["id"] = todo.get("todoId")
...
def run():
    logFile = open('037_projecttodo_to_obligationlist.log', 'w')
    ...
    print '\n'
    print '------------------------------------------'
    print 'Please check log file "037_projecttodo_to_obligationlist.log" in this directory for details'
    print '------------------------------------------'
