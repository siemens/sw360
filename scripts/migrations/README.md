...
The scripts are written in `python3` and depend on `python3-couchdb`. The couchdb has to run and be accessible on `localhost:5984`.

All scripts are migrated to python3 and should be run with `python3`. The scripts are not compatible with python2.
