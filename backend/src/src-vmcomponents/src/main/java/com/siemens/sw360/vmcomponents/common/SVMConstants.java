 ...
 * 02110-1301, USA.
 */
package com.siemens.sw360.vmcomponents.common;
...
public class SVMConstants {
    ...
    private static final String SVM_BASE_HOST_URL = "https://svm.cert.siemens.com";
    private static final String SVM_API_ROOT_PATH = "/portal/api/v1/public";
